...
![Demo Application Map](https://github.com/swimos/swim-greenhouse/blob/develop/javascript/httpServer/views/assets/images/swim-demo-app-flow.gif "Demo Application Map")
...
To get started:
1. Clone the repo `git clone https://github.com/swimos/swim-greenhouse.git`
2. CD into the new directory `cd swim-greenhouse`
